                ...
                <div class="nav-wrapper">
                    <ul class="navbar-list right">
                        ...
                        <li><a class="waves-effect waves-block waves-light sidenav-trigger" href="#"
                                data-target="slide-out-right"><i class="material-icons">headset_mic</i></a>
                        </li>
                    </ul>
    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light navbar-full sidenav-active-rounded ">
        ...
        <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow "
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i
                        class="material-icons">folder_open</i><span class="menu-title">E-Journal</span></a>
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i
                        class="material-icons">description</i><span class="menu-title">SK</span></a>
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        <li><a href="/listSk"><i
                                    class="material-icons">radio_button_unchecked</i><span>List</span></a>
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i
                        class="material-icons">drafts</i><span class="menu-title" data-i18n="Surat">Surat</span></a>
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        <li><a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i
                                    class="material-icons">file_download</i><span data-i18n="Second level child">Surat
                                    Masuk</span></a>
                            <div class="collapsible-body">
                                <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        ...
                        <li><a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i
                                    class="material-icons">file_upload</i><span data-i18n="Second level child">Surat
                                    Keluar</span></a>
                            <div class="collapsible-body">
                                <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                                    <li><a href="/listSurat"><i
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i
                        class="material-icons">person</i><span class="menu-title">User</span></a>
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                ...
                <div class="slide-out-right-body row pl-3">
                    <div id="messages" class="col s12 pb-0">
                        <input class="header-search-input mt-4 mb-2" type="text" name="Search"
                                placeholder="Search" />
                        <p class="mt-5 mb-0 ml-5 font-weight-400">SILAHKAN HUBUNGI TERKAIT KENDALA</p>
                        <div class="collection border-none mb-0">
                            <ul class="collection right-sidebar-chat p-0 mb-0">
                                ...
                                <div class="user-content">
                                    <h6 class="line-height-0">M. Sabri Rabbani</h6>
            ...
            <li class="chat-body">
                <ul class="collection">
                    ...
                    <li class="collection-item display-flex avatar justify-content-end pl-5 pb-0"
                        data-target="slide-out-chat">
                        <div class="user-content speech-bubble-right">
                            <p class="medium-small">Materialize admin is the responsive materializecss admin template.
                            </p>
                        </div>
                    </li>
