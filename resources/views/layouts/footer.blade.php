...
<footer class="page-footer footer footer-static footer-dark gradient-45deg-indigo-purple gradient-shadow navbar-border navbar-shadow">
        <div class="footer-copyright">
            <div class="container"><span>&copy; <?php echo date("Y"); ?> <a href="http://tdmrc.usk.ac.id" target="_blank">TDMRC</a> All rights reserved.</span><span class="right hide-on-small-only">Design and Developed by <a href="https://pixinvent.com/">Developer</a></span></div>
        </div>
    </footer>
<!-- END: Footer-->